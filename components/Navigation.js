...
export default function Navigation(){
    ...
    return(
        ...
        <div className="flex flex-row justify-center items-center gap-8"><a href="https://opensea.io/assets/0xbd4455da5929d5639ee098abfaa3241e9ae111af/159" target="_blank" rel="noreferrer" className="text-black dark:text-white mix-blend-difference font-Outfit font-medium text-lg border-[2px] px-[1.2rem] py-2 border-black dark:border-white hover:border-[#f8ef02] dark:hover:border-[#f8ef02] hover:text-[#f8ef02] rounded-full">Buy Now</a>{renderThemeChanger()}</div>
        </nav>
        </Fragment>
    )
}